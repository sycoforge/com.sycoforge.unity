   ...
   */
        ...
        public static void DrawLine(Vector2 start, Vector2 end, Color color, float width)
        {
            ...
            else
            {
                ...
                Vector3 perpendicular = (startPt - endPt).normalized * (width/2);
        ...
        public static void DrawLine(Vector3 start, Vector3 end, Color color, float width)
        {
            ...
            else
            {
                ...
                Vector3 perpendicular = Vector3.Cross((end - start).normalized, (start - c.transform.position).normalized) * (width / 2);
